...
//
//	when "message" is published run "callback" with "subscriber" as first argument
//
Sim.Publisher.prototype.subscribe = function(message, subscriber, callback) {
    ...
    console.log("subscribe \'"+message+"\': " + subscribers.length);
}
...
Sim.Publisher.prototype.publish = function(message) {
	...
	//
    var subscribers = this.messageTypes[message];
    console.log("publish:" + message + " to " + subscribers.length);
    if (subscribers) {
...
Sim.App.prototype.init = function(param) {
    ...
    //
    //	This is obsolete in recent versions of threejs
    //
    ...
    if (intersected.object) {
    	if (intersected.object.handleMouseDown) {
    		intersected.object.handleMouseDown(
    			event.pageX, event.pageY, intersected.point, intersected.normal);
...
Sim.App.prototype.objectFromMouse = function(pagex, pagey) {
    ...
    //
    //	Obsolete in recent versions of threejs:
    //
    ...
    //console.log("objectFromMouse: "+this.scene.children.length);
    var intersects = ray.intersectObjects( this.scene.children );
    //console.log("objectFromMouse: "+intersects.length);
